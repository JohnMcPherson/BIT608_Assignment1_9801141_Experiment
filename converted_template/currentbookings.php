// ASSUMPTIONS
// We will do filtering by customer when connecting up to the back end
// we use this as the only navigation path to make a booking
<?php
include "header.php";
include "menu.php";
...
$query = 'SELECT roomID,roomname,roomtype FROM booking ORDER BY checkindate';
$result = mysqli_query($DBC,$query);
$rowcount = mysqli_num_rows($result); 
?>
<h1>Current bookings</h1>
<h2><a href='/bnb/converted_template/makeabooking.php'>[Make a booking]</a><a href="/bnb/converted_template/">[Return to main page]</a></h2>
<table border="1">
